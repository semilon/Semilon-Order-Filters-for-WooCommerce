...
if(!class_exists('Semilon_Order_Filters_For_Woocommerce')) {
    ...
    class Semilon_Order_Filters_For_Woocommerce
    {
        ...
        private function filters_manager()
        {
            require_once __DIR__ . '/admin/class-semilon-order-filters-manager.php';
            new Semilon_Order_Filters_Manager();
        }
